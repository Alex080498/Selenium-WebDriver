...
public class TestProductOpensCorrectly_Firefox {
...
//in Chrome
    ...
    public void mainTest() {
        ...
        Assert.assertTrue(greyPriceInCatalog.equals("rgb(119, 119, 119)"));
        Assert.assertTrue(redSalePriceInCatalog.equals("rgb(204, 0, 0)"));
        ...
        Assert.assertTrue(driver.findElement(By.className("regular-price")).getCssValue("color").equals("rgb(102, 102, 102)")); // обычная цена на детальной странице серая
        ...
        Assert.assertTrue(driver.findElement(By.className("campaign-price")).getCssValue("color").equals("rgb(204, 0, 0)")); // акционная цена красная
